...
const Attorny_Info_Apoinmnt_Dtls = ({attorneyInfo}) => {

    let {image,name, designation,email,phone,experience,qualification} = attorneyInfo;
...
export default Attorny_Info_Apoinmnt_Dtls;