...
const Attorney = ({attorney}) => {
    ...
    return (
        ...
        <div className="mt-6">
          <p className="mb-3 font-medium work-sans">Experience: <span className="font-medium work-sans text-[#818B8F]">{experience}</span></p>
          <p>Qualification: <span className="font-medium work-sans text-[#818B8F]">{qualification}</span></p>
        </div>
        <div className="mt-10 flex justify-between items-center">
          ...
          <p className="text-[#B68C5A] font-semibold text-lg work-sans">${price}</p>
        </div>
      </div>
    );
};
