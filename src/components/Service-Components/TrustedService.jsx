        ...
        <div className="max-w-[1320px] mx-auto w-full py-[60px] work-sans  eb-garamond">
              ...
              <div className="mt-[50px] mb-14 px-2 xl:hidden block">
                <div className="flex lg:gap-60 md:gap-24 sm:gap-7 smaller:gap-12 xs:gap-7 justify-center">
                  <img className="lg:w-[135px] lg:h-[48px] sm:w-[111px] sm:h-[41px] w-[74px] h-[30px]" src={company} alt="" />
                  <img className="lg:w-[135px] lg:h-[48px] sm:w-[111px] sm:h-[41px] w-[74px] h-[30px]" src={company1} alt="" />
                  <img className="lg:w-[135px] lg:h-[48px] sm:w-[111px] sm:h-[41px] w-[74px] h-[30px]" src={company2} alt="" />
                </div>
                <div className="flex lg:gap-60 md:gap-24 sm:gap-7 smaller:gap-12 xs:gap-7 justify-center mt-5">
                  <img className="lg:w-[135px] lg:h-[48px] sm:w-[111px] sm:h-[41px] w-[74px] h-[30px]" src={company3} alt="" />
                  <img className="lg:w-[135px] lg:h-[48px] sm:w-[111px] sm:h-[41px] w-[74px] h-[30px]" src={company4} alt="" />
                  <img className="lg:w-[135px] lg:h-[48px] sm:w-[111px] sm:h-[41px] w-[74px] h-[30px]" src={company5} alt="" />
                </div>
              </div>
            </div>
    );
