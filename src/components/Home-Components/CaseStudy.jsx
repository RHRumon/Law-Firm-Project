...
const CaseStudy = () => {
  return (
    <div className="min-h-fit work-sans text-black">
      <div className="max-w-[1320px] mx-auto w-full xl:pt-[150px] xl:pb-[75px] md:py-16 py-[29px] xl:px-5 md:px-7 smaller:px-8 small:px-4">
        <div className="lg:space-y-4 eb-garamond text-center sm:text-start">
          <p className="text-xl font-medium text-[#D4AF37]">Case Study</p>
